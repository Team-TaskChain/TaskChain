...
contract TaskChain {    
    //creates the sets to activate 'CRUD' capabilities for the smart contract
    using HitchensUnorderedAddressSetLib for HitchensUnorderedAddressSetLib.Set;
    HitchensUnorderedAddressSetLib.Set userSet;
    using HitchensUnorderedKeySetLib for HitchensUnorderedKeySetLib.Set;
    HitchensUnorderedKeySetLib.Set contractSet;  
    
    // defines userType: Creators add tasks, 
    // Workers complete tasks, 
    // Arbitrators resolve disputes, Admins perform 
    // administrative and punitive functions
    ...
    //retrieves user from directory set
    ...
    //gets the number of users, enables iterating over user list
    function getUserCount() public view returns(uint count) {
        return userSet.count();
    }

    //gets user at specific index
