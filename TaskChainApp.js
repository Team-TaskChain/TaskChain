...
// Create an instance of the smart con// The object 'Contracts' will be injected here, which contains all data for all contracts, keyed on contract name:
// Contracts['HelloWorld'] = {
//  abi: [],
//  address: "0x..",
//  endpoint: "http://...."
...
$(document).ready(function () {
    task.onReady();
});tract, passing it as a property, 
// which allows web3js to interact with it.
function TaskChain(Contract) {
    this.web3 = null;
    this.instance = null;
